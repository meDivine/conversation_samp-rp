 ...
 */
     ...
     */
         ...
         * @return bool True if the item was successfully removed. False if there was an errors.
         * @throws \Psr\SimpleCache\InvalidArgumentException
         *   MUST be thrown if the $key string is not a legal value.
         * @static
         */
         ...
         * @return bool True if the items were successfully removed. False if there was an errors.
         * @throws \Psr\SimpleCache\InvalidArgumentException
         *   MUST be thrown if $keys is neither an array nor a Traversable,
         *   or if any of the $keys are not a legal value.
         * @static
...
')
     ...
     * @method static void errors(mixed $message)
